    ...
    <section className="relative bg-radial from-blue-900 from-11% to-blue-800 to-100% min-h-screen">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 h-full">
        <div className="flex flex-col justify-between items-center text-center h-screen py-8">
            ...
            <div className="relative flex flex-col h-1/2 md:justify-end md:bottom-6 items-center gap-2">
            ...
            <div className = "flex flex-col h-1/2 justify-between">
                {/* Middle: Headline */}
                <h1 className="text-4xl font-insideout font-bold tracking-wider text-white md:text-7xl">
                    Make A Core Memory
                </h1>

...
export default function Links() {
        return (
                <>
                        <section className='grid justify-center items-center text-black p-8' id="links">
                                ...
                                <div className=" flex flex-col gap-5 max-w-[400px]">
                                        ...
                                        <section className="flex flex-col gap-4">
                                                ...
                                                <Link title={"Primer"}
                                                        desc={"bit.ly/GW26-B2-Registration Primer"}
                                                        url={"bit.ly/GW26-B2-Registration"}></Link>
                                        </section>
                                        <hr className="h-[1px] bg-[#E5E7EB] border-none" />
                                        <section className="flex flex-col gap-4">
                                                <div className="font-jost-medium text-center text-xl leading-[16px]"> Previous Years</div>
                                                <div className='flex flex-col gap-2'>
                                                        <Link title={"Yearbook & Graduation Photos Distribution"}
                                                                desc={"Green & White Unclaimed Yearbooks & Photos"}
                                                                url={"https://fb.com/gwyearbookdlsu/posts/1469838278266286"}></Link>
                                                        ...
                                                        <Link title={"Yearbook Finder"}
                                                                desc={"Green & White Batch Status and Updates"}

...
export default function ComingSoon() {
  ...
  const stickers = {
    ...
    mobile: {//652 (y)
      y1924:        { w: 120, h: 100,  x: 0.80, y: 1 },
      cat:          { w: 140, h: 140,  x: 0.05, y: 0.85 },
      booklet:      { w: 150, h: 150,  x: 0.20, y: 0.90 },
      id:           { w: 120, h: 100,  x: 0.00, y: 0.78 },
      grad:         { w: 160, h: 130,  x: 0.52, y: 0.15 },
      matcha:       { w: 95, h: 115,  x: 0.75, y: 0.75 },
